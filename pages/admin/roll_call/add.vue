...
onMounted( async () => {
  ...
  roll_call.value.member_visit_list.length = 0;
...
<!--          <p class="text-black dark:text-white text-xl">{{rollCallStore.data.edit_roll_call.roll_call_man}}</p>-->
        ...
        <div class="grid gap-6 grid-cols-2 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          ...
          <div v-for="(member, index) in roll_call.member_visit_list"  class="p-5 flex flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" >
