...
<template>
  <div class="dark:bg-black bg-white flex justify-center container-top w-full">
    <div class="w-full lg:w-3/4 mx-5">
      <div class="grid gap-6 mb-6 grid-cols-4 items-center pt-5">
        <div class="">
...
<!--          <p class="text-2xl p-2 md:text-3xl font-normal text-gray-700 dark:text-gray-400">{{index}}</p>-->
          ...
          <div class="inline-flex rounded-md shadow-sm" role="group">
            <NuxtLink to="/admin/member/edit">
              <button @click="membersStore.getEdit(member.id)" type="button" class="text-xl md:text-3xl px-4 py-2 font-medium text-gray-900 bg-transparent border border-gray-900 rounded-l-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
                編輯
              </button>
            </NuxtLink>
