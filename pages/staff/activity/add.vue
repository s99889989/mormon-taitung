...
onMounted(()=>{
  active.value.date = todayDate();
  active.value.time = currentTime();
  active.value.end_date = todayDate();
  active.value.end_time = currentTime();

  activeStore.data.edit_active = active.value;
  ...
  <div class="dark:bg-black bg-white flex justify-center container-top w-full">
    <div class="w-full lg:w-3/4">
      ...
      <div class="grid gap-6 grid-cols-1 items-center pt-5 px-5">
        ...
        <span class=" text-center text-4xl font-medium text-gray-900 dark:text-white">新增活動</span>
...
<!--        <p class="text-gray-900 dark:text-white">{{active.date}}-{{active.time}}</p>-->
        ...
        <div class="grid gap-6 grid-cols-2">
          <NuxtLink @click="activeStore.add()" to="/staff/activity/list" type="button" class="text-center text-2xl text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg px-5 py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            新增</NuxtLink>
          <NuxtLink to="/staff/activity/list" type="button" class="text-center text-2xl text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg px-5 py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            取消</NuxtLink>
        </div>
        <br/><br/><br/>
      </div>
